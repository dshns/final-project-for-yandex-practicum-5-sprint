...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	runningCalories := (CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	walkingCalories := (CaloriesWeightMultiplier*w.Weight + (math.Pow((w.meanSpeed()*KmHInMsec), 2)/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	swimmingCalories := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
